<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	...
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php esc_attr_e('Import', 'vp_textdomain') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	...
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php esc_attr_e('Export', 'vp_textdomain') ?>" />
				<span style="margin-left: 10px;">
