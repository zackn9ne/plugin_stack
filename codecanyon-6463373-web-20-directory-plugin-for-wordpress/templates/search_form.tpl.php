...
<form action="<?php echo $search_url; ?>" class="w2dc-content w2dc-search-form">
	...
	<?php if (get_option('w2dc_show_what_search')): ?>
		<div class="w2dc-row">
			...
			<div class="w2dc-search-section-label w2dc-col-md-12"><?php _e('Filter By:', 'W2DC'); ?></div>
	...
	<?php endif; ?>
		...
		<div class="w2dc-row">
			<div class="w2dc-col-md-6 w2dc-form-group w2dc-pull-right w2dc-text-right">
				<input type="submit" name="submit" class="w2dc-btn w2dc-btn-primary" value="<?php esc_attr_e('Filter', 'W2DC'); ?>" />
			</div>
