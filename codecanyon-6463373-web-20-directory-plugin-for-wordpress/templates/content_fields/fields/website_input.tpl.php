	...
	<div class="w2dc-col-md-10">
		<div class="w2dc-row">
			<div class="w2dc-col-md-12">
				...
				<input type="text" name="w2dc-field-input-url_<?php echo $content_field->id; ?>" class="w2dc-field-input-url w2dc-form-control regular-text" value="<?php echo esc_url($content_field->value['url']); ?>" /><br />
			</div>
