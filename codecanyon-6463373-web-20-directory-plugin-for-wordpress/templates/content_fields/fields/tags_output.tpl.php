...
<div class="w2dc-field w2dc-field-output-block w2dc-field-output-block-<?php echo $content_field->type; ?> w2dc-field-output-block-<?php echo $content_field->id; ?>">
	...
	<?php //echo get_the_term_list($listing->post->ID, W2DC_TAGS_TAX, '', ', ', ''); ?>
		...
		foreach ($terms as $term): ?>
			<span class="w2dc-label w2dc-label-primary"><a href="<?php echo get_term_link($term, W2DC_TAGS_TAX); ?>" rel="tag"><?php echo $term->name; ?></a>&nbsp;&nbsp;<span class="w2dc-glyphicon w2dc-glyphicon-tag"></span></span>
		<?php endforeach; ?>
	</span>
</div>
<?php endif; ?>