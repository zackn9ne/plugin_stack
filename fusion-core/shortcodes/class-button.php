	...
	function render( $args, $content = '') {
		...
		if( ( $color == 'custom' || $color == 'default' ) &&
            ...
            if ( $text_color_styles ) {
                $styles .= sprintf( '.fusion-button.button-%s .fusion-button-text{%s}', $this->button_counter, $text_color_styles );
			}
            ...
            if ( $text_color_hover_styles ) {
                $styles .= sprintf( '.fusion-button.button-%s:hover .fusion-button-text,.fusion-button.button-%s:focus .fusion-button-text,.fusion-button.button-%s:active .fusion-button-text{%s}', $this->button_counter, $this->button_counter, $this->button_counter, $text_color_hover_styles );
            }                			
