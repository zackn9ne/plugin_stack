...
( function($) {
	...
	**/
	fusionParser.buildContentBoxShortocde = function( args ) {
        ...
        shortcodeData+= ' linktarget="'+args[21].value+'"';
        shortcodeData+= ' animation_delay="'+args[22].value+'"';
        shortcodeData+= ' animation_type="'+args[23].value+'"';
        shortcodeData+= ' animation_direction="'+args[24].value+'"';
        shortcodeData+= ' animation_speed="'+args[25].value+'"';
        shortcodeData+= ' margin_top="'+args[26].value+'"';
        shortcodeData+= ' margin_bottom="'+args[27].value+'"';
		shortcodeData+= ' class="'+args[28].value+'"';
		shortcodeData+= ' id="'+args[29].value+'"]';

		totalElements 	= args[30].elements.length;
		subElements		= args[30].elements;

		for ( i = 0; i < totalElements; i++) {
			subElements		= args[30].elements[i];
	...
	**/
	fusionParser.buildCountdownShortocde = function( args ) {
		...
		shortcodeData+= ' show_weeks="'+args[1].value+'"';
		shortcodeData+= ' background_color="'+args[2].value+'"';
		...
		shortcodeData+= ' border_radius="'+args[6].value+'"';
		shortcodeData+= ' counter_box_color="'+args[7].value+'"';
        shortcodeData+= ' counter_text_color="'+args[8].value+'"';
		shortcodeData+= ' heading_text="'+args[9].value+'"';
		shortcodeData+= ' heading_text_color="'+args[10].value+'"';
		shortcodeData+= ' subheading_text="'+args[11].value+'"';
		shortcodeData+= ' subheading_text_color="'+args[12].value+'"';
		shortcodeData+= ' link_text="'+args[13].value+'"';
		shortcodeData+= ' link_text_color="'+args[14].value+'"';
		shortcodeData+= ' link_url="'+args[15].value+'"';
		shortcodeData+= ' link_target="'+args[16].value+'"';
